  ...
  useEffect(() => {
    fetch("/api/settings")
      ...
      .then(data => {
        ...
        setSocials({
          telegramUrl: s.telegram_url || s.telegramUrl || "https://t.me/familymsk",
          vkUrl: s.vk_url || s.vkUrl || "https://vk.ru/thefamilymskk",
          instagramUrl: s.instagram_url || s.instagramUrl || "https://www.instagram.com/thefamily_msk",
        });
      })
      .catch(() => {});
  }, []);
        ...
        <div className="md:hidden fixed inset-0 z-[60] bg-black">
          <nav className="flex flex-col items-center justify-center h-full gap-1 px-6">
            ...
            <Link
              ...
              className="mt-4 w-full max-w-xs flex items-center justify-center gap-2 px-6 py-4 bg-white text-black rounded-2xl text-base font-bold tracking-wide touch-manipulation"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              КУПИТЬ БИЛЕТЫ
            </Link>
            ...
            <div className="flex items-center gap-4 mt-6 mb-6">
              <a href={socials.telegramUrl} target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-white/10 flex items-center justify-center touch-manipulation">
              ...
              <a href={socials.vkUrl} target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-white/10 flex items-center justify-center touch-manipulation">
              ...
              <a href={socials.instagramUrl} target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-white/10 flex items-center justify-center touch-manipulation">
