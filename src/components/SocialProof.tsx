...
const testimonials = [
  {
    text: "Лучшая тусовка в Москве! Атмосфера просто огонь 🔥",
    author: "Алексей",
    event: "UGLYSTEPHAN",
    rating: 5,
  },
  {
    text: "Организация на высшем уровне, звук бомба, всем советую!",
    author: "Мария",
    event: "FAMILY VIBES",
    rating: 5,
  },
  {
    text: "Незабываемые эмоции! Уже жду следующее мероприятие 💜",
    author: "Дмитрий",
    event: "NEON NIGHTS",
    rating: 5,
  },
    ...
    <section className="relative py-16 sm:py-24 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-12 text-center">
          <p className="text-text-secondary mb-4 text-sm">Следи за нами в соцсетях</p>
